...
const tmpDir = path.join(os.tmpdir(), `hyper-fs-bench-readfile-${Date.now()}`)
...
group('readFile (package.json, utf8)', () => {
  ...
  bench('Hyper-FS', () => readFileSync(realFile, { encoding: 'utf8' }))
})
